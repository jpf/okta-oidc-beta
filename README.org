...
*** Fetching public keys for OIDC in Python
    ...
    #+NAME: autodiscover_jwks_and_load_public_keys
    #+BEGIN_SRC python
    ...
    Below is a quote from the [[https://tools.ietf.org/html/draft-ietf-jose-json-web-key-31#section-4.7]["x5c" section in the JSON Web Key specification]]:
    ...
    #+NAME: clean_inputs_from_id_token
    #+BEGIN_SRC python
    ...
    #+NAME: test_fetch_public_key_for_when_empty :exports none
    #+BEGIN_SRC python
      @raises(NameError)
